...
require_once 'controllers/default/ProductsController.php';
...
ROUTE::run('/api'); // You can add a prefix here. For example '/api' the prefix '/api' will be added for the 4 URLs above.
?>